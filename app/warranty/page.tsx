      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div 
            ...
            className="bg-white p-8 rounded-lg shadow-lg text-center opacity-0 transition-all duration-700"
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-gray-800 mb-6">Insurance Details</h3>
        ...
        <div 
          ref={processRef}
          className="bg-white p-8 rounded-lg shadow-lg mb-16 opacity-0 transition-all duration-700"
        >
          <h2 className="text-3xl font-bold text-green-500 mb-8 text-center">How to Make a Warranty Claim</h2>
        ...
        >
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-gray-800 mb-6">Warranty Contact</h3>
        ...
        >
          <div className="bg-green-500 text-white p-8 rounded-lg max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <div className="grid grid-cols-3 gap-2 items-center w-full max-w-md md:flex md:gap-4 md:max-w-none md:justify-center">
                <Button 
                  className="bg-green-600 text-white px-2 py-1 rounded-lg font-semibold hover:bg-green-700 transition-colors text-xs text-center md:px-8 md:py-3 md:text-base"
                  asChild
                >
                  <Link href="/book-online">Book Service</Link>
                </Button>
                <span className="text-white font-medium text-xs text-center md:text-base">or</span>
                <Button 
                  className="bg-white text-green-500 px-2 py-1 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-xs text-center leading-tight md:px-8 md:py-3 md:text-base"
                  asChild
                >
